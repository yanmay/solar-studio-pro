// Client-side PDF report generator for URJA LINK
...
export function generatePDFReport(
  ...
  try {
    const doc = new jsPDF({ orientation: "portrait", unit: "mm", format: "a4" });
      ...
      doc.setFontSize(8);
      doc.text("Generated by URJA LINK — urjalink.in", pageWidth / 2, pageHeight - 10, { align: "center" });
      ...
      doc.save(`URJA_LINK_Solar_Report_${analysis.analysisId}.pdf`);
    } catch (error) {
      throw error;
    }
}
